...
def main():
    ...
    mapping_file = '/home/dmd/Workplace/HiMap2/Morpher_CGRA_Mapper/applications/clustered_arch/edn/jpegdct_POST_LN111_PartPred_DFG.xmlstdnoc_3x3tiles_3x3PEs.json_MTP=1_Iter=5.mappingwithlatency.txt'
